...
int isMoveAngle()
{
	...
	if (Keyboard_IsPress(DIK_LEFT) && Keyboard_IsPress(DIK_UP))    //左上
		return  225;

	if (Keyboard_IsPress(DIK_LEFT) && Keyboard_IsPress(DIK_DOWN))    //左下
		return 135;

	if (Keyboard_IsPress(DIK_RIGHT) && Keyboard_IsPress(DIK_DOWN))    //右下
		return  45;
