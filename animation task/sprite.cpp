...
void spriteDraw(int textureId, D3DXVECTOR4 position, D3DCOLOR color, int cut_x, int cut_y, int cut_w, int cut_h, D3DXVECTOR2 center, float angle) {
	...
	float v1 = (cut_y + cut_h) / (float)h;
	Vertex2d v[] = {
		{ D3DXVECTOR4((float)-cut_w / 2,(float)-cut_h / 2,position.z,position.w),color,D3DXVECTOR2(u0,v0) },
		{ D3DXVECTOR4((float)+cut_w / 2,(float)-cut_h / 2,position.z,position.w),color,D3DXVECTOR2(u1,v0) },
		{ D3DXVECTOR4((float)-cut_w / 2,(float)+cut_h / 2,position.z,position.w),color,D3DXVECTOR2(u0,v1) },
		{ D3DXVECTOR4((float)+cut_w / 2,(float)+cut_h / 2,position.z,position.w),color,D3DXVECTOR2(u1,v1) },
	};
